...
SECRET_KEY = 'django-insecure-f#xt9n)*^=*&1!_cz$n*5ec191lzo7ulsfg(@58t*4@b0mu-42'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, r'C:\Users\cetecom\Desktop\MiProyecto\MiProyecto\plantillas')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
